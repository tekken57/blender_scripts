...
# Extended bone name to ID map from 3ds Max (provided map)
bone_name_to_max_id = {
    ...
    "Main_Root": 68, "J_IndexF0_L": 69, "J_MiddleF0_L": 70, "J_PinkyF0_L": 71,
    "J_RingF0_L": 72, "J_IndexF0_R": 73, "J_MiddleF0_R": 74, "J_PinkyF0_R": 75,
    "J_RingF0_R": 76, "H_Delt_L_OS01": 77, "H_TrapBase_L": 78, "H_TrapBase_R": 79,
    "H_Delt_R_OS01": 80, "H_Hip_L_OS1": 81, "H_Kn_L_OS01": 82, "H_Kn_L_OS02": 83,
    "H_Hip_R_OS1": 84, "H_Kn_R_OS01": 85, "H_Kn_R_OS02": 86, "H_Leg_Vol_C_L": 87,
    "H_Leg_Vol_C_R": 88
}

class ExportBoneWeightsAllBonesOperator(bpy.types.Operator, ExportHelper):
    bl_idname = "export_weights_all.folder"
    bl_label = "Export Bone Weights (All Bones)"
    filename_ext = ""
...
def register():
    bpy.utils.register_class(ExportBoneWeightsAllBonesOperator)

def unregister():
    bpy.utils.unregister_class(ExportBoneWeightsAllBonesOperator)
